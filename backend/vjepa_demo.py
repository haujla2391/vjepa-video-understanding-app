...
try:
    from decord import VideoReader  # works with decord2
except ImportError:
    raise ImportError("You need decord2 installed: pip install decord2")
from transformers import AutoModel, AutoVideoProcessor

vjepa2_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'vjepa2'))
